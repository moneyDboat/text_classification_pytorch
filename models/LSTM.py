...
class LSTMBI(nn.Module):
    ...
    def __init__(self, opt):
        ...
        self.word_embeddings.weight = nn.Parameter(opt.embeddings, requires_grad=opt.emb_train)
        ...
        self.bilstm = nn.LSTM(opt.embedding_dim, opt.hidden_dim // 2, num_layers=self.lstm_layers, dropout=self.dropout,
                              bidirectional=True)
