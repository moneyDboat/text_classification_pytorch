...
train_iter = data.Iterator(datasets=train, batch_size=128, train=True, repeat=False, device=0)
val_iter = data.Iterator(datasets=val, batch_size=128, train=False, repeat=False, device=0)
test_iter = data.Iterator(dataset=test, batch_size=128, train=False, sort=False, device=0)
